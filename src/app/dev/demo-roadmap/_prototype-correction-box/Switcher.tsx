...
// skill's UI convention. wayframe#9.
import { useRouter, usePathname, useSearchParams } from "next/navigation";
import { useCallback, useEffect } from "react";

export const VARIANTS = [
  { key: "a", label: "A — Floating command bar" },
  { key: "b", label: "B — Correction sidebar" },
  { key: "c", label: "C — Select-then-describe" },
] as const;
...
export function Switcher() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 z-50 flex -translate-x-1/2 items-center gap-3 rounded-full border border-fuchsia-400 bg-fuchsia-950/90 px-4 py-2 text-sm text-white shadow-lg shadow-fuchsia-900/40">
