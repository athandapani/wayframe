// PROTOTYPE — configurable 2/3-tier date axis (Year always on top; Quarter
// and/or Month as user-chosen finer tiers). Answers "2 or 3 tier year/qtr or
// year/qtr/month, let user choose what's in the 2nd and 3rd tier" feedback
// on wayframe issue #7.
