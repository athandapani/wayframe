...
// PROTOTYPE — throwaway. wayframe#23, Variant B.
//
// Two panes, always both visible (no tab-switching — text and photo are
// options, not a source you pick between). Errors are fully differentiated
// per /api/extract's typed ExtractionError kind, with a collapsible
// "Show details" for the two kinds that carry an `issues[]` list. Sample
// content is split per-pane — "Use sample notes" and "Use sample photo" are
// independent, so a visitor can see each affordance without triggering both.
