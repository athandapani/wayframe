...
// PROTOTYPE — throwaway. Floating variant switcher for the 3 entry-page
// input-surface layouts, per the /prototype skill's UI convention. wayframe#23.
import { useRouter, usePathname, useSearchParams } from "next/navigation";
import { useCallback, useEffect } from "react";

export const VARIANTS = [
  { key: "a", label: "A — Unified composer, drop-anywhere" },
  { key: "b", label: "B — Two-pane form, typed errors" },
  { key: "c", label: "C — Chat-style hero composer" },
] as const;

export type VariantKey = (typeof VARIANTS)[number]["key"];

export function useEntryVariant(): VariantKey {
