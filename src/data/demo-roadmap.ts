...
export const demoRoadmap: RoadmapData = {
  ...
  milestones: [
    ...
    { id: "mech-5", laneId: "lane-mech", title: "Pilot-Build Hardware Lot (x10)", date: "2026-09-25", originalDate: "2026-09-04", status: "at-risk", owner: "R. Alvarez — Hardware Eng Lead", comment: "Long-lead motor controller shipment slipped 3 weeks.", percentComplete: 70, dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: false },
    ...
    { id: "pilot-5", laneId: "lane-pilot", title: "Pilot Fleet Uptime ≥ 95% Sustained (30 days)", date: "2027-01-05", status: "not-started", owner: "K. Simmons — Field Ops", dependsOn: [{ id: "pilot-4", showConnector: true }], linksToTopLevelMilestone: "top-ga", isCriticalPath: false },
    ...
    { id: "launch-3", laneId: "lane-launch", title: "Sales Enablement & Demo Kit Ready", date: "2026-11-15", status: "not-started", dependsOn: [{ id: "launch-2", showConnector: false }], linksToTopLevelMilestone: null, isCriticalPath: true },
    {
      id: "launch-4",
      laneId: "lane-launch",
