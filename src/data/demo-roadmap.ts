...
export const demoRoadmap: RoadmapData = {
  ...
  milestones: [
    ...
    { id: "mech-4", laneId: "lane-mech", title: "Ruggedized Enclosure Qualification", date: "2026-05-20", endDate: "2026-07-05", status: "complete", owner: "R. Alvarez — Hardware Eng Lead", comment: "Passed vibration and ingress testing at outside lab.", dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: false },
    { id: "mech-5", laneId: "lane-mech", title: "Pilot-Build Hardware Lot (x10)", date: "2026-09-25", endDate: "2026-11-10", originalDate: "2026-09-04", status: "at-risk", owner: "R. Alvarez — Hardware Eng Lead", comment: "Long-lead motor controller shipment slipped 3 weeks.", percentComplete: 70, dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: false },
    ...
    { id: "auto-2", laneId: "lane-auto", title: "SLAM Localization Alpha", date: "2025-12-01", endDate: "2026-01-20", status: "complete", owner: "N. Kessler — Autonomy Lead", dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: false },
    { id: "auto-3", laneId: "lane-auto", title: "Obstacle-Avoidance Beta", date: "2026-04-01", status: "complete", dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: false },
    { id: "auto-4", laneId: "lane-auto", title: "Fleet Coordination Software v1", date: "2026-09-20", status: "on-track", owner: "N. Kessler — Autonomy Lead", dependsOn: [{ id: "auto-3", showConnector: true }], linksToTopLevelMilestone: null, isCriticalPath: false },
    { id: "auto-5", laneId: "lane-auto", title: "Perception Accuracy Field Validation", date: "2026-10-15", endDate: "2026-12-01", status: "at-risk", owner: "N. Kessler — Autonomy Lead", comment: "Dust/low-light false-negative rate above target in the Warehouse B testbed.", percentComplete: 60, dependsOn: [{ id: "auto-4", showConnector: true }], linksToTopLevelMilestone: null, isCriticalPath: false },
    { id: "auto-6", laneId: "lane-auto", title: "Autonomy Release Candidate", date: "2026-11-01", status: "not-started", dependsOn: [{ id: "auto-5", showConnector: true }], linksToTopLevelMilestone: null, isCriticalPath: false },
    ...
    { id: "safety-2", laneId: "lane-safety", title: "Functional Safety Plan (IEC 61508-aligned)", date: "2026-01-15", status: "complete", dependsOn: [{ id: "safety-1", showConnector: false }], linksToTopLevelMilestone: null, isCriticalPath: true },
    { id: "safety-3", laneId: "lane-safety", title: "UL 3100 Pre-Assessment", date: "2026-05-01", endDate: "2026-06-10", status: "complete", owner: "T. Boyer — Safety & Compliance", dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: false },
    { id: "safety-4", laneId: "lane-safety", title: "Third-Party Safety Lab Testing", date: "2026-10-20", endDate: "2026-12-05", originalDate: "2026-09-15", status: "delayed", owner: "T. Boyer — Safety & Compliance", comment: "Lab slot pushed to Q4 due to backlog at the certifying body.", percentComplete: 40, dependsOn: [{ id: "mech-5", showConnector: true }], linksToTopLevelMilestone: null, isCriticalPath: false, showReferenceLine: true },
    { id: "safety-5", laneId: "lane-safety", title: "UL 3100 Certification Issued", date: "2026-12-15", status: "not-started", owner: "T. Boyer — Safety & Compliance", attachments: [{ type: "link", url: "https://example.com/wayframe-demo/ul3100-certificate.pdf", label: "UL 3100 Certificate (PDF)" }], dependsOn: [{ id: "safety-4", showConnector: true }], linksToTopLevelMilestone: "top-ga", isCriticalPath: false },
    ...
    { id: "mfg-2", laneId: "lane-mfg", title: "Long-Lead Component Sourcing (Motors, Lidar)", date: "2025-12-15", endDate: "2026-03-01", status: "complete", comment: "Dual-sourced lidar to de-risk a single supplier.", dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: false },
    ...
    { id: "pilot-3", laneId: "lane-pilot", title: "Pilot Site 2 Go-Live", date: "2026-09-20", endDate: "2026-11-05", status: "at-risk", owner: "K. Simmons — Field Ops", comment: "Site network infra delayed by the facility landlord.", percentComplete: 65, dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: false },
    { id: "pilot-4", laneId: "lane-pilot", title: "Pilot Site 3 Go-Live", date: "2026-11-01", status: "not-started", dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: false },
    { id: "pilot-5", laneId: "lane-pilot", title: "Pilot Fleet Uptime ≥ 95% Sustained (30 days)", date: "2027-01-05", endDate: "2027-02-04", status: "not-started", owner: "K. Simmons — Field Ops", dependsOn: [{ id: "pilot-4", showConnector: true }], linksToTopLevelMilestone: "top-ga", isCriticalPath: false },
    ...
    { id: "launch-2", laneId: "lane-launch", title: "Channel Partner Agreements Signed", date: "2026-09-10", endDate: "2026-10-25", status: "on-track", owner: "M. Delgado — GTM Lead", percentComplete: 50, dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: false },
    { id: "launch-3", laneId: "lane-launch", title: "Sales Enablement & Demo Kit Ready", date: "2026-11-15", endDate: "2026-12-20", status: "not-started", dependsOn: [{ id: "launch-2", showConnector: false }], linksToTopLevelMilestone: null, isCriticalPath: true },
    {
      id: "launch-4",
      laneId: "lane-launch",
