...
export const demoRoadmap: RoadmapData = {
  ...
  milestones: [
    ...
    { id: "mech-5", laneId: "lane-mech", title: "Pilot-Build Hardware Lot (x10)", date: "2026-09-25", originalDate: "2026-09-04", status: "at-risk", owner: "R. Alvarez — Hardware Eng Lead", comment: "Long-lead motor controller shipment slipped 3 weeks.", percentComplete: 70, dependsOn: [], linksToTopLevelMilestone: null, isCriticalPath: true },
